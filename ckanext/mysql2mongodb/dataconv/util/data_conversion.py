...
from ckanext.mysql2mongodb.dataconv.constant.consts import MYSQL_MONGO_MAP, MONGO_DECIMAL_DATATYPE, \
    MONGO_OBJECT_DATATYPE, MYSQL_BINARY_DATATYPE, MYSQL_STRING_DATATYPE, MYSQL_DATE_DATATYPE
    ...
    try:
        ...
        for record in fetched_data:
            ...
            for idx, column_name in enumerate(column_type_map.keys()):
                ...
                elif mongo_datatype == MONGO_OBJECT_DATATYPE and not isinstance(cell_data, str):
